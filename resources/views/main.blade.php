...
<head>
    ...
    <title>UAS | Gilang Maulana</title>
...
<body id="page-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-light fixed-top shadow-sm" id="mainNav">
        <div class="container px-5">
            <a class="navbar-brand fw-bold" href="#page-top">5C-Gilang Maulana</a>
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="navbar-nav ms-auto me-4 my-3 my-lg-0">
                    ...
                    <li class="nav-item"><a class="nav-link me-lg-3" href="#informasimagang">Informasi Magang</a></li>
                </ul>
            ...
            <div class="row gx-5 align-items-center">
                <div class="col-lg-6">
                    ...
                    <div class="mb-5 mb-lg-0 text-center text-lg-start">
                        <h1 class="display-1 lh-1 mb-3">Temukan Masa Depanmu Disini.</h1>
                        <p class="lead fw-normal text-muted mb-5">Tersedia banyak lowongan magang yang akan menunjang
                            karir masa depanmu. stay tune!</p>
                ...
                <div class="col-sm-8 col-md-6">
                    <div class="px-5 px-sm-0">
                        <div class="px-5 px-sm-0"><img class="img-fluid rounded-circle" src="{{ asset('img/jumbotron.png') }}" height="100" alt="..." /></div>
                    </div>
                </div>
            </div>
        </div>
    ...
    <aside class="text-center bg-gradient-primary-to-secondary">
        <div class="container px-5">
            <div class="row gx-5 justify-content-center">
                <div class="col-xl-8">
                    <div class="h2 fs-1 text-white mb-4">"A Goal Without A Plan Is Just A Wish"</div>
                        ...
                        <div class="row gx-5">
                            <div class="col-md-6 mb-5">
                                ...
                                <div class="text-center">
                                    ...
                                    <h3 class="font-alt">Keaslian Informasi</h3>
                            ...
                            <div class="col-md-6 mb-5">
                                ...
                                <div class="text-center">
                                    ...
                                    <h3 class="font-alt">Siapapun Bisa!</h3>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-5 mb-md-0">
                                ...
                                <div class="text-center">
                                    ...
                                    <h3 class="font-alt">Menjamin Masa Depan</h3>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="text-center">
                                    ...
                                    <h3 class="font-alt">Gapai Kesuksesanmu!</h3>
        ...
        <div class="container px-5">
            <div class="row gx-5 align-items-center justify-content-center justify-content-lg-between">
                <div class="col-12 col-lg-5">
                    <h2 class="display-4 lh-1 mb-4">Buatlah sebuah karya untuk masa depan dunia.</h2>
                    ...
                    <div class="card shadow-sm">
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                <div class="btn-group">
                                    <a href="/detailmagang/{{ $magang->id }}" class="btn btn-sm btn-outline-secondary">Detail</a>
                                    <form action="/{{ $magang->id}}/edit" method="post" class="d-inline">
                                        @method('put')
                                        @csrf
                                        <input name="_method" type="hidden" value="UPDATE">
                                        <button class="btn btn-sm btn-outline-primary show_confirm_lamar">Lamar</button>
                                </div>
                                </form>
    ...
    <footer class="bg-black text-center py-5">
        <div class="container px-5">
            <div class="text-white-50 small">
                <div class="mb-2">&copy; 5C Gilang Maulana 2022. All Rights Reserved.</div>
                <a href="#!">Privacy</a>
